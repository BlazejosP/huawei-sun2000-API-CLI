...
# You must have installed on your linux tools like jq, httpie, grep, curl
...
# If variable in config section on top is true insert data to Domoticz
if [[ $send_data_to_Domoticz == true ]];
	then
	...
	if [[ $Domoticz_with_username_and_password == true ]];
		...
		curl -i  -H "Content-Type: application/json" "http://$domtoicz_username:$domtoicz_password@$domtoicz_server:$domoticz_port/json.htm?type=command&param=udevice&idx=$domoticz_device_configuration_idx&nvalue=0&svalue="$Inverter+$EnergyStore+$Meter+$RadiationDose+$UserPower""
		...
		curl -i  -H "Content-Type: application/json" "http://$domtoicz_username:$domtoicz_password@$domtoicz_server:$domoticz_port/json.htm?type=command&param=udevice&idx=$domoticz_current_power_idx&nvalue=0&svalue=$currentPowerforDomoticz_after_modifications"
		...
		curl -i  -H "Content-Type: application/json" "http://$domtoicz_username:$domtoicz_password@$domtoicz_server:$domoticz_port/json.htm?type=command&param=udevice&idx=$domoticz_daily_power_idx&svalue=$dailyPowerforDomoticz_after_modifications2"
		...
		curl -i  -H "Content-Type: application/json" "http://$domtoicz_username:$domtoicz_password@$domtoicz_server:$domoticz_port/json.htm?type=command&param=udevice&idx=$domoticz_monthly_power_idx&svalue=$monthlyPowerforDomoticz_after_modifications2"
		...
		curl -i  -H "Content-Type: application/json" "http://$domtoicz_username:$domtoicz_password@$domtoicz_server:$domoticz_port/json.htm?type=command&param=udevice&idx=$domoticz_yearly_power_idx&svalue=$yearlyPowerforDomoticz_after_modifications2"
		...
		curl -i  -H "Content-Type: application/json" "http://$domtoicz_username:$domtoicz_password@$domtoicz_server:$domoticz_port/json.htm?type=command&param=udevice&idx=$domoticz_all_power_idx&svalue=$allPowerforDomoticz_after_modifications2"

	else
		#Description of devices configuration	
		curl -i  -H "Content-Type: application/json" "http://$domtoicz_server:$domoticz_port/json.htm?type=command&param=udevice&idx=$domoticz_device_configuration_idx&nvalue=0&svalue="$Inverter+$EnergyStore+$Meter+$RadiationDose+$UserPower""
